...
type JobPositionManagementUsecase interface {
	...
	GetJobPositions(page, limit int) ([]entity.JobPosition, error)
...
func (u *jobPositionManagementUsecase) GetJobPositions(page, limit int) ([]entity.JobPosition, error) {
	return u.repo.GetJobPositions(page, limit)
}
