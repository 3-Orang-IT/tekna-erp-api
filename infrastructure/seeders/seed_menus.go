	...
	menusList := []entity.Menu{
		...
		{Name: "Master Data", Icon: "DatabaseIcon", Order: 2, Children: []entity.Menu{
			...
			{Name: "Sistem & Konfigurasi", Icon: "CogIcon", Order: 6, Children: []entity.Menu{
				...
				{Name: "Template Email", URL: "/master-data/template-email", Icon: "EnvelopeIcon", Order: 4},
				{Name: "Workflow Setting", URL: "/master-data/workflow", Icon: "ArrowPathIcon", Order: 5},
				{Name: "System Parameter", URL: "/master-data/system-parameter", Icon: "AdjustmentsHorizontalIcon", Order: 6},
			}},
