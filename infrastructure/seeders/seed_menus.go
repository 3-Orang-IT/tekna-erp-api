...
func SeedMenus(db *gorm.DB) error {
	menusList := []entity.Menu{
		...
		{Name: "Master Data", Icon: "DatabaseIcon", Order: 2, Children: []entity.Menu{
			...
			{Name: "Sistem & Konfigurasi", Icon: "CogIcon", Order: 6, Children: []entity.Menu{
				{Name: "Kategori Dokumen", URL: "/master-data/kategori-dokumen", Icon: "DocumentIcon", Order: 1},
				{Name: "Template Email", URL: "/master-data/template-email", Icon: "EnvelopeIcon", Order: 2},
				{Name: "Workflow Setting", URL: "/master-data/workflow", Icon: "ArrowPathIcon", Order: 3},
				{Name: "System Parameter", URL: "/master-data/system-parameter", Icon: "AdjustmentsHorizontalIcon", Order: 4},
			}},
